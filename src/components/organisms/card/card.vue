...
<template>
  <q-card dark class="bg-gradient border-dark-300 border-dotted border-8">
    <q-card-section class="grid grid-cols-[auto,auto]">
      ...
      <span class="ml-auto p-1 bg-dark-300 text-gray-400 rounded-4xl">
        ...
        <span class="mx-2 rounded-xl text-lime-800 text-gray-400">
          ...
          <carbon-restart v-else-if="server.status === Status.RESTARTING" class="align-text-top animate-spin-slow h-26px" />
    ...
    <q-card-actions class="text-white">
      ...
      <q-btn
        ...
        push size="lg" class="bg-fuchsia-800"
      >
        Swap
      </q-btn>
    </q-card-actions>
